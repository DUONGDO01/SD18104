...
<div class="container">
    <div class="body">
        <fs:form action="/cua-hang/update/${cuahang.ma}" modelAttribute="cuahang" method="post" >
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <fs:input type="text" name="thanhPho" path="thanhPho" class="form-control" id=""/>
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Quốc Gia :</label>
                <fs:input type="text" name="quocGia"  path="quocGia" class="form-control" />
                <fs:errors path="quocGia" cssStyle="color: red"></fs:errors>
            </div>
