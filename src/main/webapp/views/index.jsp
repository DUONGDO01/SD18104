    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="nha-san-xuat/index">Nhà Sản Xuất</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="chi-tiet-sp/index">Chi Tiết Sản Phẩm</a>
                </li>
                <li class="nav-item">
